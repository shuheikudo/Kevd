      SUBROUTINE DLAED3X( K, N, N1, D, Q, LDQ, RHO, DLAMDA, Q2, INDX,
     $                   CTOT, W, S, INFO )
*
...
*
*
*     Modified by Shuhei Kudo, May 2015.
...
*     Compute updated W.
*     Initialize S(I) = Q(I,I)
      CALL DCOPY( K, Q, LDQ+1, S, 1 )
      DO 60 J = 1, K
         DO 40 I = 1, J - 1
            S( I ) = S( I )*( Q( I, J ) / ( DLAMDA( I )-DLAMDA( J ) ) )
   40    CONTINUE
         DO 50 I = J + 1, K
            S( I ) = S( I )*( Q( I, J ) / ( DLAMDA( I )-DLAMDA( J ) ) )
   50    CONTINUE
